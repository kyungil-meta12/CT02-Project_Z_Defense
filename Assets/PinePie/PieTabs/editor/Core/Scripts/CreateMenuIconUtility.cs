...
namespace PinePie.PieTabs
{
    public static class CreateMenuIconUtility
    {
        ...
        public static void GetIconFromCreateMenu(Action<string> onDone, string menuPath, WinInstanceInfo info)
        {
            fetchingIcon = true;
            _done = onDone;
            ...
            if (PieTabsPrefs.InstantCreatorTab) Navigator.ForceEndRenaming(info.editorWindow);
        }
    }
}
#endif
