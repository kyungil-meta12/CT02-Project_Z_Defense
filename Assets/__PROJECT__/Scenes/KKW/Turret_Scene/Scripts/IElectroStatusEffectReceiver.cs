...
namespace ProjectZDefense.StatusEffects
{
    ...
    public struct ElectroStatusPayload
    {
        ...
        public float shockStackOrbitRadius;
        public float shockStackVerticalOffset;
        public float shockStackOrbitDegreesPerSecond;
        public Vector3 shockStackVisualScale;
        public bool useBossShockStackOrbitRadius;
        public float bossShockStackOrbitRadius;
        public bool useBossShockStackVisualScale;
        public Vector3 bossShockStackVisualScale;
        public bool hideBackSideShockStackVisuals;
        public float backSideHideDotThreshold;
        public bool useShockStackBackSideAlphaFade;
        public float shockStackFrontAlpha;
        public float shockStackBackAlpha;
        public float shockStackAlphaFadeSharpness;
        public float shockStackAlphaLerpSpeed;
        public bool useShockStackChargedVisualMode;
        public int chargedShockStackVisualThreshold;
